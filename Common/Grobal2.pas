...
//==============================================================================
 ...
 { SM_27 = 27;
  ...
  SM_WINEXP = 44;//获取经验
  SM_LEVELUP = 45;//升级
  SM_DAYCHANGING = 46;//太阳月亮

  SM_LOGON = 50;//登陆
  SM_NEWMAP = 51;//新地图
  SM_ABILITY = 52;//打开属性对话框
  SM_HEALTHSPELLCHANGED = 53;//治愈术增加血
  ...
  SM_ID_NOTFOUND = 502;
  SM_PASSWD_FAIL = 503;//验证失败
  SM_NEWID_SUCCESS = 504;//建立帐号成功
  SM_NEWID_FAIL = 505;//建立帐号失败
  ...
  SM_ITEMHIDE = 611;
  //  SM_DOOROPEN           = 612;
  SM_OPENDOOR_OK = 612; //通过门
  SM_OPENDOOR_LOCK = 613;//通过门锁 以前盛大秘密通道去赤月的门要5分钟开一次
  SM_CLOSEDOOR = 614;//关门
  SM_TAKEON_OK = 615;
  SM_TAKEON_FAIL = 616;
  SM_TAKEOFF_OK = 619;
  ...
  SM_RECONNECT = 802; //与服务器重新连接
  SM_GHOST = 803;
  SM_SHOWEVENT = 804;
  SM_HIDEEVENT = 805;
  SM_SPACEMOVE_HIDE2 = 806;
  SM_SPACEMOVE_SHOW2 = 807;
  SM_TIMECHECK_MSG = 810;//时钟检测以免客户端作弊
  SM_ADJUST_BONUS = 811; //?
  ...
  RM_SYSMESSAGE = 10100;
  RM_GROUPMESSAGE = 10102;//组队聊天
  RM_SYSMESSAGE2 = 10103;
  RM_GUILDMESSAGE = 10104;//行会聊天
  ...
  CM_DROPITEM = 1000;//扔松溪
  CM_PICKUP = 1001;//捡东西
  CM_TAKEONITEM = 1003;//装备物品
  CM_TAKEOFFITEM = 1004;//卸载装备
  CM_EAT = 1006;//吃药
  CM_BUTCH = 1007;
  ...
  CM_MERCHANTQUERYSELLPRICE = 1012;//返回价格
  CM_USERSELLITEM = 1013;//买麦西
  CM_USERBUYITEM = 1014;//买东西
  CM_USERGETDETAILITEM = 1015;
  CM_DROPGOLD = 1016;//扔掉钱币
  CM_LOGINNOTICEOK = 1018;//健康游戏公告
  CM_GROUPMODE = 1019;
  CM_CREATEGROUP = 1020;
  CM_ADDGROUPMEMBER = 1021;
  CM_DELGROUPMEMBER = 1022;
  CM_USERREPAIRITEM = 1023;//修理物品
  CM_MERCHANTQUERYREPAIRCOST = 1024;//获取修理费用
  CM_DEALTRY = 1025;//开始交易
  CM_DEALADDITEM = 1026;//交易增加物品
  CM_DEALDELITEM = 1027;//交易减少物品
  CM_DEALCANCEL = 1028;//取消交易
  CM_DEALCHGGOLD = 1029;//交易金钱
  CM_DEALEND = 1030;//交易完成
  CM_USERSTORAGEITEM = 1031;//寄存物品
  CM_USERTAKEBACKSTORAGEITEM = 1032;//取回物品
  CM_WANTMINIMAP = 1033;
  CM_USERMAKEDRUGITEM = 1034;//制造毒品
  CM_OPENGUILDDLG = 1035;

  //行会
  CM_GUILDHOME = 1036;//行会主页
  CM_GUILDMEMBERLIST = 1037;//成员猎豹
  CM_GUILDADDMEMBER = 1038;//添加成员
  CM_GUILDDELMEMBER = 1039;//删除成员
  CM_GUILDUPDATENOTICE = 1040;//修改公告
  CM_GUILDUPDATERANKINFO = 1041;//更新联盟信息
  ...
  CM_QUERYBAGITEMS = 81;//查询角色物品

  CM_QUERYUSERSET = 49999;

  CM_OPENDOOR = 1002;//开门
  CM_SOFTCLOSE = 1009;//客户端发送的命令 退出 打退或者小退
  CM_1017 = 1017;
  CM_1042 = 1042;
  CM_GUILDALLY = 1044;
...
{5种空间门}
  ...
  CM_PROTOCOL = 2000;
  CM_IDPASSWORD = 2001;//发送帐号密码
  CM_ADDNEWUSER = 2002;//新建用户
  CM_CHANGEPASSWORD = 2003;//修改密码
  CM_UPDATEUSER = 2004;
  CM_RANDOMCODE = 2006;//随机代码
  SM_RANDOMCODE = 2007;
