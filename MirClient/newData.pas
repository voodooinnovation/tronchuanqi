...
interface
uses
   Windows, Classes, Graphics, SysUtils, Textures, GameImages, wmUnit, DIB, ZlibEx, HUtil32,
  CompressUnit, CompressUnit1;
type
   pTDataImages = ^TDataImages;
    TDataImages = class(TGameImages)
  private
    FCompress: Integer;
    FHeader: TDataHeader;
...
constructor TDataImages.Create();
begin
  inherited;
  m_FileStream := nil;
...
destructor TDataImages.Destroy;
begin
  m_IndexList.Free;
  inherited;
end;
...
procedure TDataImages.Initialize;
begin
...
procedure TDataImages.Finalize;
var
  I: Integer;
begin
...
procedure TDataImages.LoadIndex();
var
  I, Value: Integer;
  PValue: PInteger;
begin
...
function TDataImages.Comp(const InData: Pointer; InSize: LongInt; out OutData: Pointer): Integer;
begin
  case FCompress of
...
function TDataImages.UnComp(const InData: Pointer; InSize: LongInt; out OutData: Pointer): Integer;
begin
  case FCompress of
...
procedure TDataImages.LoadDxImage(Position: Integer; DXImage: pTDXImage);
const
...
procedure TDataImages.LoadDxBitmap(Position: Integer; DXImage: pTDXImage);
const
  RGB565_MASK_RED = $F800;
  RGB555_MASK_RED = $07C0;
var
...
function TDataImages.GetCachedBitmap(Index: Integer): TBitmap;
var
  nPosition: Integer;
  nErrCode: Integer;
begin
...
function TDataImages.GetCachedSurface(Index: Integer): TTexture;
var
  nPosition: Integer;
  nErrCode: Integer;
begin
...
function TDataImages.GetCachedImage(Index: Integer; var PX, PY: Integer): TTexture;
var
  nPosition: Integer;
  nErrCode: Integer;
begin
...
function TDataImages.GetBitmap(Index: Integer; var PX, PY: Integer): TBitmap;
var
  nPosition: Integer;
  nErrCode: Integer;
begin
