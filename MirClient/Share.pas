...
const
  ...
  ITEMDESCFILE = 'Data\ItemDesc.Dat';//物品描述
  (*
{$IF CUSTOMLIBFILE = 1}
  EFFECTIMAGEDIR = 'Graphics\Effect\';
  MAINIMAGEFILE = 'Graphics\FrmMain\Main.Wzl';
  MAINIMAGEFILE2 = 'Graphics\FrmMain\Main2.Wzl';
  MAINIMAGEFILE3 = 'Graphics\FrmMain\Main3.Wzl';
{$ELSE}
  MAINIMAGEFILE = 'Data\Prguse.Wzl';
  MAINIMAGEFILE2 = 'Data\Prguse2.Wzl';
  MAINIMAGEFILE3 = 'Data\Prguse3.Wzl';
...
{$IFEND}
  ...
  EFFECTIMAGEDIR = 'Data\';
  NPCFACEIMAGEFILE = 'Data\NpcFace.Wzl';
  FNPCIMAGESFILE = 'Data\F-Npc.Data';

{$IF MIRSCLIENT = 0}
  MAINIMAGEFILE = 'Data\Prguse.Wzl';//界面1
  MAINIMAGEFILE2 = 'Data\Prguse2.Wzl';//界面2
  MAINIMAGEFILE3 = 'Data\Prguse3.Wzl';//界面3
  UI1IMAGEFILE = 'Data\ui1.Wzl';//ui1
  UI3IMAGEFILE = 'Data\ui3.Wzl';//ui3
{$ELSE}
  MAINIMAGEFILE = 'Data\Prguse_16.Wzl';
  MAINIMAGEFILE2 = 'Data\Prguse2_16.Wzl';
  MAINIMAGEFILE3 = 'Data\Prguse3_16.Wzl';
{$IFEND}


{$IF MIRSCLIENT = 0}
  CHRSELIMAGEFILE = 'Data\ChrSel.Wzl';
{$ELSE}
  CHRSELIMAGEFILE = 'Data\ChrSel_16.Wzl';
{$IFEND}

  MINMAPIMAGEFILE = 'Data\mmap.Wzl';
  TITLESIMAGEFILE = 'Data\Tiles.Wzl';
  TITLES2IMAGEFILE = 'Data\Tiles2.Wzl';
  SMLTITLESIMAGEFILE = 'Data\SmTiles.Wzl';
  SMLTITLES2IMAGEFILE = 'Data\SmTiles2.Wzl';
  HUMWINGIMAGESFILE = 'Data\HumEffect.Wzl';
  HUM1WINGIMAGESFILE = 'Data\HumEffect1.Wzl';
  HUM2WINGIMAGESFILE = 'Data\HumEffect2.Wzl';
  MAGICONIMAGESFILE = 'Data\MagIcon.Wzl';
  HUMIMGIMAGESFILE = 'Data\Hum.Wzl';
  HAIRIMGIMAGESFILE = 'Data\Hair.Wzl';
  HAIRIMGIMAGESFILE2 = 'Data\Hair2.Wzl';
  WEAPONIMAGESFILE = 'Data\Weapon.Wzl';
  NPCIMAGESFILE = 'Data\Npc.Wzl';
  MAGICIMAGESFILE = 'Data\Magic.Wzl';
  MAGIC2IMAGESFILE = 'Data\Magic2.Wzl';
  MAGIC3IMAGESFILE = 'Data\Magic3.Wzl';
  MAGIC4IMAGESFILE = 'Data\Magic4.Wzl';
  MAGIC5IMAGESFILE = 'Data\Magic5.Wzl';
  MAGIC6IMAGESFILE = 'Data\Magic6.Wzl';
  EVENTEFFECTIMAGESFILE = EFFECTIMAGEDIR + 'Event.Wzl';
  BAGITEMIMAGESFILE = 'Data\Items.Wzl';
  STATEITEMIMAGESFILE = 'Data\StateItem.Wzl';
  DNITEMIMAGESFILE = 'Data\DnItems.Wzl';
  OBJECTIMAGEFILE = 'Data\Objects.Wzl';
  OBJECTIMAGEFILE1 = 'Data\Objects%d.Wzl';
  MONIMAGEFILE = 'Data\Mon%d.Wzl';
  DRAGONIMAGEFILE = 'Data\Dragon.Wzl';//红龙+特效
  EFFECTIMAGEFILE = 'Data\Effect.Wzl';//特效

  MONIMAGEFILEEX = 'Graphics\Monster\%d.Wzl';
  MONPMFILE = 'Graphics\Monster\%d.pm';

  CQFIRIMAGESFILE = 'Data\F-Cqfir.Data';

  HORSEIMAGESFILE = 'Data\F-Horse.Wzl';
  HUMHORSEIMAGESFILE = 'Data\F-HumHorse.Wzl';
  HAIRHORSEIMAGESFILE = 'Data\F-HairHorse.Wzl';

  HUMIMGIMAGESFILES = 'Data\Hum%d.Wzl';
  WEAPONIMAGESFILES = 'Data\Weapon%d.Wzl';
  ...
  sGameNoticeName = '健康游戏公告';//登陆界面底部文字
  sGameNoticeStr1 = '抵制不良游戏，拒绝盗版游戏，注意自我保护，谨防受骗上当。适度游戏益脑，';
  sGameNoticeStr2 = '沉迷游戏伤身，合理安排时间，享受健康生活，严厉打击赌博，营造和谐环境。';
var

 //{$IF SWH = SWH800}
  SCREENWIDTH: Integer = 800; //分辨率
  SCREENHEIGHT: Integer = 600; //分辨率
//{$ELSEIF SWH = SWH1024}
  //SCREENWIDTH = 1024;
  //SCREENHEIGHT = 768;
//{$IFEND}

  MAPSURFACEWIDTH: Integer = 800;//地图表面宽
  MAPSURFACEHEIGHT: Integer = 600;//地图表面高
