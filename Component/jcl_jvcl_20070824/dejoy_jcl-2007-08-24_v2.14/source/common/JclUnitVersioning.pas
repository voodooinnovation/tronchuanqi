...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net:443/svnroot/jcl/trunk/jcl/source/common/JclUnitVersioning.pas $';
    Revision: '$Revision: 1671 $';
    Date: '$Date: 2006-05-29 15:02:45 -0700 (Mon, 29 May 2006) $';
    LogPath: 'JCL\common';
  );
