...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvThread.pas 11429 2007-07-30 21:06:50Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvThread.pas $';
    Revision: '$Revision: 11429 $';
    Date: '$Date: 2007-07-30 14:06:50 -0700 (Mon, 30 Jul 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
