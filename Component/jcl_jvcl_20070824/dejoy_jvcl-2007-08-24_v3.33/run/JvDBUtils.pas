...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBUtils.pas 10790 2006-07-06 16:49:16Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBUtils.pas $';
    Revision: '$Revision: 10790 $';
    Date: '$Date: 2006-07-06 09:49:16 -0700 (Thu, 06 Jul 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
