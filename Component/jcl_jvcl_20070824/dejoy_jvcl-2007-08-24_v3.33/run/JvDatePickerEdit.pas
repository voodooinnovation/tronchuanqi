...
-----------------------------------------------------------------------------}
// $Id: JvDatePickerEdit.pas 11449 2007-08-13 16:56:20Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDatePickerEdit.pas $';
    Revision: '$Revision: 11449 $';
    Date: '$Date: 2007-08-13 09:56:20 -0700 (Mon, 13 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
