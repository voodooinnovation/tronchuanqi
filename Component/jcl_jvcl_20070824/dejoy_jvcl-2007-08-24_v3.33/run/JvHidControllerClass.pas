...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvHidControllerClass.pas 11394 2007-06-28 18:50:22Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvHidControllerClass.pas $';
    Revision: '$Revision: 11394 $';
    Date: '$Date: 2007-06-28 11:50:22 -0700 (Thu, 28 Jun 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
{$ENDIF USEJVCL}
