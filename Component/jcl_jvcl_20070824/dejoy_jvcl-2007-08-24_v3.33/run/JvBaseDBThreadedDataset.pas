...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvBaseDBThreadedDataset.pas 11424 2007-07-29 18:00:26Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvBaseDBThreadedDataset.pas $';
    Revision: '$Revision: 11424 $';
    Date: '$Date: 2007-07-29 11:00:26 -0700 (Sun, 29 Jul 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
