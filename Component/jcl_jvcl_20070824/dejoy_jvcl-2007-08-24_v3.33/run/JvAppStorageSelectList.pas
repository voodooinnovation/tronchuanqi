...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAppStorageSelectList.pas 11413 2007-07-11 20:23:46Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvAppStorageSelectList.pas $';
    Revision: '$Revision: 11413 $';
    Date: '$Date: 2007-07-11 13:23:46 -0700 (Wed, 11 Jul 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
