...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvFormMagnet.pas 10721 2006-06-22 18:43:34Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvFormMagnet.pas $';
    Revision: '$Revision: 10721 $';
    Date: '$Date: 2006-06-22 11:43:34 -0700 (Thu, 22 Jun 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
