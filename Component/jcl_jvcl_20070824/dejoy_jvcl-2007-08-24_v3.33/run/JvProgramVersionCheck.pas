...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvProgramVersionCheck.pas $';
    Revision: '$Revision: 11059 $';
    Date: '$Date: 2006-11-29 09:12:58 -0800 (Wed, 29 Nov 2006) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
