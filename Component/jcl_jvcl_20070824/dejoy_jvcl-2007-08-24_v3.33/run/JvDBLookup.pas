...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBLookup.pas 11471 2007-08-18 12:23:50Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBLookup.pas $';
    Revision: '$Revision: 11471 $';
    Date: '$Date: 2007-08-18 05:23:50 -0700 (Sat, 18 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
