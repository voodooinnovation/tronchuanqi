...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAppRegistryStorage.pas 10958 2006-10-03 14:03:55Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvAppRegistryStorage.pas $';
    Revision: '$Revision: 10958 $';
    Date: '$Date: 2006-10-03 07:03:55 -0700 (Tue, 03 Oct 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
