...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvToolBar.pas 11040 2006-11-25 15:49:51Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvToolBar.pas $';
    Revision: '$Revision: 11040 $';
    Date: '$Date: 2006-11-25 07:49:51 -0800 (Sat, 25 Nov 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
