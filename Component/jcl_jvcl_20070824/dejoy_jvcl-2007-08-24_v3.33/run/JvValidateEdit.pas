...
-----------------------------------------------------------------------------}
// $Id: JvValidateEdit.pas 11404 2007-07-03 17:24:26Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvValidateEdit.pas $';
    Revision: '$Revision: 11404 $';
    Date: '$Date: 2007-07-03 10:24:26 -0700 (Tue, 03 Jul 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
