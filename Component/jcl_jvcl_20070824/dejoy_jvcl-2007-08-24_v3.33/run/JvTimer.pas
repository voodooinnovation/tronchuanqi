...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvTimer.pas 11077 2006-12-12 13:40:55Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvTimer.pas $';
    Revision: '$Revision: 11077 $';
    Date: '$Date: 2006-12-12 05:40:55 -0800 (Tue, 12 Dec 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
