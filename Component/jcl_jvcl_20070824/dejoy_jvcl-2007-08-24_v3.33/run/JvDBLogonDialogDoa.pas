...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBLogonDialogDoa.pas 11199 2007-03-02 23:27:55Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBLogonDialogDoa.pas $';
    Revision: '$Revision: 11199 $';
    Date: '$Date: 2007-03-02 15:27:55 -0800 (Fri, 02 Mar 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
