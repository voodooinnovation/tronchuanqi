...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBActionsEngineDatasetOdac.pas 11427 2007-07-29 19:16:10Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBActionsEngineDatasetOdac.pas $';
    Revision: '$Revision: 11427 $';
    Date: '$Date: 2007-07-29 12:16:10 -0700 (Sun, 29 Jul 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
