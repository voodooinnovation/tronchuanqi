...
// $Id: JvDBGrid.pas 11464 2007-08-17 15:30:38Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBGrid.pas $';
    Revision: '$Revision: 11464 $';
    Date: '$Date: 2007-08-17 08:30:38 -0700 (Fri, 17 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
