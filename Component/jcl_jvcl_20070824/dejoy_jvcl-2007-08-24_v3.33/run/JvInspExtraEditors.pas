...
{$ENDIF UNITVERSIONING}
  SysUtils, Classes,
  Windows, Graphics, Controls, StdCtrls, ImgList, Dialogs, Forms,
  JvInspector;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvInspExtraEditors.pas $';
...
procedure TJvInspectorColorItem.EditMouseDown(Sender: TObject; Button: TMouseButton;
