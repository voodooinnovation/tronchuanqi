...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDynControlEngineDevExpCxDB.pas $';
    Revision: '$Revision: 11456 $';
    Date: '$Date: 2007-08-13 16:48:41 -0700 (Mon, 13 Aug 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
