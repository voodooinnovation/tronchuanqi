...
-----------------------------------------------------------------------------}
// $Id: JvColorCombo.pas 11388 2007-06-26 12:56:22Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvColorCombo.pas $';
    Revision: '$Revision: 11388 $';
    Date: '$Date: 2007-06-26 05:56:22 -0700 (Tue, 26 Jun 2007) $';
    LogPath: 'JVCL\run'
    );
  {$ENDIF UNITVERSIONING}
