...
-----------------------------------------------------------------------------}
// $Id: JvListBox.pas 11043 2006-11-26 07:21:48Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvListBox.pas $';
    Revision: '$Revision: 11043 $';
    Date: '$Date: 2006-11-25 23:21:48 -0800 (Sat, 25 Nov 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
