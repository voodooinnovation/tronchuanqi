...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBImage.pas 11362 2007-06-21 06:59:12Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBImage.pas $';
    Revision: '$Revision: 11362 $';
    Date: '$Date: 2007-06-20 23:59:12 -0700 (Wed, 20 Jun 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
