...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvExExtCtrls.pas 11407 2007-07-05 17:11:35Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvExExtCtrls.pas $';
    Revision: '$Revision: 11407 $';
    Date: '$Date: 2007-07-05 10:11:35 -0700 (Thu, 05 Jul 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
