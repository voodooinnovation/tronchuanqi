...
-----------------------------------------------------------------------------}
// $Id: JvUpDown.pas 11431 2007-08-06 12:00:39Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvUpDown.pas $';
    Revision: '$Revision: 11431 $';
    Date: '$Date: 2007-08-06 05:00:39 -0700 (Mon, 06 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
