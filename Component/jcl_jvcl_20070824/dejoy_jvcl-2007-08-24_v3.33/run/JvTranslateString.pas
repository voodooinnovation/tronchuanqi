...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvTranslateString.pas 11032 2006-11-24 08:05:37Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvTranslateString.pas $';
    Revision: '$Revision: 11032 $';
    Date: '$Date: 2006-11-24 00:05:37 -0800 (Fri, 24 Nov 2006) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
