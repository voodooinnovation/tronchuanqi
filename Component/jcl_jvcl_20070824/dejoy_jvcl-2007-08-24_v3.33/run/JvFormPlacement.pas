...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvFormPlacement.pas 11416 2007-07-11 22:23:01Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvFormPlacement.pas $';
    Revision: '$Revision: 11416 $';
    Date: '$Date: 2007-07-11 15:23:01 -0700 (Wed, 11 Jul 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
