...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvResources.pas 11400 2007-06-28 21:24:06Z ahuser $
...
resourcestring
  RsButtonLoadCaption = 'Load';
  RsButtonSaveCaption = 'Save';
  RsButtonClearCaption = 'Clear';
...
//=== JvInspector.pas ========================================================
resourcestring
  RsStringPictureEditorCaption = 'Picture Editor';
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvResources.pas $';
