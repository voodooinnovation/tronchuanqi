...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvBackgrounds.pas 11310 2007-06-04 00:27:25Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvBackgrounds.pas $';
    Revision: '$Revision: 11310 $';
    Date: '$Date: 2007-06-03 17:27:25 -0700 (Sun, 03 Jun 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
{$ENDIF USEJVCL}
