...
-----------------------------------------------------------------------------}
// $Id: JvListView.pas 11434 2007-08-07 08:33:06Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvListView.pas $';
    Revision: '$Revision: 11434 $';
    Date: '$Date: 2007-08-07 01:33:06 -0700 (Tue, 07 Aug 2007) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
