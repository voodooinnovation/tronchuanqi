...
-----------------------------------------------------------------------------}
// $Id: JvProgressForm.pas 11423 2007-07-19 06:59:25Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvProgressForm.pas $';
    Revision: '$Revision: 11423 $';
    Date: '$Date: 2007-07-18 23:59:25 -0700 (Wed, 18 Jul 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
