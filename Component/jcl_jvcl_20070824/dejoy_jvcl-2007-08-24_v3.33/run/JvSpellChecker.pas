...
-----------------------------------------------------------------------------}
// $Id: JvSpellChecker.pas 10617 2006-05-22 17:45:27Z remkobonte $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvSpellChecker.pas $';
    Revision: '$Revision: 10617 $';
    Date: '$Date: 2006-05-22 10:45:27 -0700 (Mon, 22 May 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
