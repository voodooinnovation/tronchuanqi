...
-----------------------------------------------------------------------------}
// $Id: JvMail.pas 11230 2007-03-24 20:55:37Z outchy $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvMail.pas $';
    Revision: '$Revision: 11230 $';
    Date: '$Date: 2007-03-24 13:55:37 -0700 (Sat, 24 Mar 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
