...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvMemo.pas 10699 2006-06-10 17:49:41Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvMemo.pas $';
    Revision: '$Revision: 10699 $';
    Date: '$Date: 2006-06-10 10:49:41 -0700 (Sat, 10 Jun 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
