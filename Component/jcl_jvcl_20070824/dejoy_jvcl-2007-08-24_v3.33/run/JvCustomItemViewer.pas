...
-----------------------------------------------------------------------------}
// $Id: JvCustomItemViewer.pas 11221 2007-03-19 11:02:51Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvCustomItemViewer.pas $';
    Revision: '$Revision: 11221 $';
    Date: '$Date: 2007-03-19 04:02:51 -0700 (Mon, 19 Mar 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
