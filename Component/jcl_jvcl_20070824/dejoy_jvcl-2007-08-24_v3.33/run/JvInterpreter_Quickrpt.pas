...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvInterpreter_Quickrpt.pas $';
    Revision: '$Revision: 10740 $';
    Date: '$Date: 2006-06-27 01:37:49 -0700 (Tue, 27 Jun 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
