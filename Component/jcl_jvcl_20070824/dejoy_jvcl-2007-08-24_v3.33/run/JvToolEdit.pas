...
-----------------------------------------------------------------------------}
// $Id: JvToolEdit.pas 11475 2007-08-18 16:06:11Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvToolEdit.pas $';
    Revision: '$Revision: 11475 $';
    Date: '$Date: 2007-08-18 09:06:11 -0700 (Sat, 18 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
