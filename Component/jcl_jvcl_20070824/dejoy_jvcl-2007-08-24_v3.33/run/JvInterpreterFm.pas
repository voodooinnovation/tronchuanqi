...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvInterpreterFm.pas 11391 2007-06-26 15:20:39Z ivan_ra $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvInterpreterFm.pas $';
    Revision: '$Revision: 11391 $';
    Date: '$Date: 2007-06-26 08:20:39 -0700 (Tue, 26 Jun 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
