...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBPasswordDialogOdac.pas 11047 2006-11-27 07:25:28Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDBPasswordDialogOdac.pas $';
    Revision: '$Revision: 11047 $';
    Date: '$Date: 2006-11-26 23:25:28 -0800 (Sun, 26 Nov 2006) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
