...
-----------------------------------------------------------------------------}
// $Id: JvSpin.pas 11477 2007-08-18 17:34:33Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvSpin.pas $';
    Revision: '$Revision: 11477 $';
    Date: '$Date: 2007-08-18 10:34:33 -0700 (Sat, 18 Aug 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
