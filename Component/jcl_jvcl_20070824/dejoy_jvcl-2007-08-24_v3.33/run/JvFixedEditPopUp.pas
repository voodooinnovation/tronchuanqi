...
-----------------------------------------------------------------------------}
// $Id: JvFixedEditPopUp.pas 11303 2007-05-30 16:57:05Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvFixedEditPopUp.pas $';
    Revision: '$Revision: 11303 $';
    Date: '$Date: 2007-05-30 09:57:05 -0700 (Wed, 30 May 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
