...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDynControlEngineDB.pas 10842 2006-07-25 21:46:44Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net:443/svnroot/jvcl/trunk/jvcl/run/JvDynControlEngineDB.pas $';
    Revision: '$Revision: 10842 $';
    Date: '$Date: 2006-07-25 14:46:44 -0700 (Tue, 25 Jul 2006) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
