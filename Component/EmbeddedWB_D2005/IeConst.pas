(*******************************
 * IECONST 1.6 (may 10 2005) Was created by : I don't know, Found it on the web *
   Eran Bodankin (bsalsa) - added some constants *
 *******************************)
...
uses
  Sysutils, ShlObj, Activex, Windows, Urlmon;
...
const
  ...
  CONTEXT_MENU_IMGDYNSRC = 7;// These 2 are mapped to IMAGE for the public")
  CONTEXT_MENU_TABLE = 3;
  CONTEXT_MENU_TEXTSELECT = 4; // in browse mode
  ...
  IDM_AUTODETECT = 2329;
  IDM_BACKCOLOR = 51;
  IDM_BASELINEFONT1 = 2141;    // IDM_BASELINEFONT1, IDM_BASELINEFONT2, IDM_BASELINEFONT3, IDM_BASELINEFONT4,
  IDM_BASELINEFONT2 = 2142;     // and IDM_BASELINEFONT5 should be consecutive integers;
