...
#define TMSCHEMA_H
//-----------------------------------------------------------------
#include "RzTmSchema.HPP"
#include "SchemaDef.h"
//-----------------------------------------------------------------
static const int THEMEMGR_VERSION = 1;  // increment if order of props changes or
...
static const int  TMT_FIRST_RCSTRING_NAME   = ::TMT_DISPLAYNAME;
static const int  TMT_LAST_RCSTRING_NAME   	= ::TMT_DESCRIPTION;
static const int  TMT_FIRSTFONT				= ::TMT_CAPTIONFONT;
static const int  TMT_LASTFONT				= ::TMT_ICONTITLEFONT;
static const int  TMT_FIRSTBOOL   			= ::TMT_FLATMENUS;
static const int  TMT_LASTBOOL    			= ::TMT_FLATMENUS;
static const int  TMT_FIRSTSIZE   			= ::TMT_SIZINGBORDERWIDTH;
static const int  TMT_LASTSIZE     			= ::TMT_MENUBARHEIGHT;
static const int  TMT_FIRSTINT   			= ::TMT_MINCOLORDEPTH;
static const int  TMT_LASTINT    			= ::TMT_MINCOLORDEPTH;
static const int  TMT_FIRSTSTRING   		= ::TMT_CSSNAME;
static const int  TMT_LASTSTRING    		= ::TMT_XMLNAME;
static const int  TMT_FIRSTCOLOR  			= ::TMT_SCROLLBAR;
static const int  TMT_LASTCOLOR   			= ::TMT_MENUBAR;
