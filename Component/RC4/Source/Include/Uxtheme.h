...
static const int DTT_GRAYED = 0x1;         // draw a grayed-out string
...
static const int HTTB_BACKGROUNDSEG          = 0x0000  ;

//  Fixed border hit test option.  possible return values are:
//  HTCLIENT: hit test succeeded in the middle background segment
//  HTBORDER: hit test succeeded in any other background segment
static const int HTTB_FIXEDBORDER            =0x0002;  // Return code may be either HTCLIENT or HTBORDER.
...
static const int HTTB_CAPTION                = 0x0004  ;
...
static const int HTTB_RESIZINGBORDER_LEFT     = 0x0010;  // Hit test left resizing border,
static const int HTTB_RESIZINGBORDER_TOP      = 0x0020;  // Hit test top resizing border
static const int HTTB_RESIZINGBORDER_RIGHT    = 0x0040;  // Hit test right resizing border
static const int HTTB_RESIZINGBORDER_BOTTOM   = 0x0080;  // Hit test bottom resizing border

static const int HTTB_RESIZINGBORDER=         (::HTTB_RESIZINGBORDER_LEFT|::HTTB_RESIZINGBORDER_TOP| ::HTTB_RESIZINGBORDER_RIGHT|::HTTB_RESIZINGBORDER_BOTTOM);
...
static const int HTTB_SIZINGTEMPLATE      = 0x0100;
...
static const int HTTB_SYSTEMSIZINGMARGINS  = 0x0200;
...
//-----------------------------------------------------------------------
static const int MAX_INTLIST_COUNT =10;
...
static const int ETDT_DISABLE        = 0x00000001;
static const int ETDT_ENABLE         = 0x00000002;
static const int ETDT_USETABTEXTURE  = 0x00000004;
static const int ETDT_ENABLETAB      = (::ETDT_ENABLE  | ::ETDT_USETABTEXTURE);
...
static const int STAP_ALLOW_NONCLIENT=    (1 << 0);
static const int STAP_ALLOW_CONTROLS =    (1 << 1);
static const int STAP_ALLOW_WEBCONTENT=   (1 << 2);
